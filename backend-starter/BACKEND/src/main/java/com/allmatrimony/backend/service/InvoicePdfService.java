...
public class InvoicePdfService {
    ...
    private List<String> buildLines(Map<String, Object> payload) {
        ...
        String appName = display(payload.get("appName"), "All Matrimony");
        String invoiceTitle = display(payload.get("invoiceTitle"), "Service Booking Invoice");
