...
EXPO_PUBLIC_API_URL_NATIVE=http://192.168.0.23:8080
```
...
Expo tunnel hosts such as `*.exp.direct` are not your backend. The app should point to your Spring Boot server URL, usually your PC's LAN IP like `http://192.168.0.23:8080`.
