...
public class ProfileUpdateRequest {
    ...
    public String getProfileCreatedFor() { return profileCreatedFor; }
    public void setProfileCreatedFor(String profileCreatedFor) { this.profileCreatedFor = profileCreatedFor; }
    ...
    public String getPartnerAge() { return partnerAge; }
    public void setPartnerAge(String partnerAge) { this.partnerAge = partnerAge; }
    public String getPartnerCommunity() { return partnerCommunity; }
    public void setPartnerCommunity(String partnerCommunity) { this.partnerCommunity = partnerCommunity; }
    public String getPartnerLocation() { return partnerLocation; }
    public void setPartnerLocation(String partnerLocation) { this.partnerLocation = partnerLocation; }
